export default function Nav() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex items-center justify-between px-5 py-7 mix-blend-difference sm:px-10 sm:py-8">
      ...
      <a
        href="#waitlist"
        className="pointer-events-auto border-b border-mist pb-0.5 text-[11px] tracking-[0.18em] text-bone uppercase transition-opacity duration-300 hover:opacity-60"
      >
        Waitlist
      </a>
    </header>
